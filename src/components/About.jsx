        ...
        <div className='flex w-full flex-col lg:flex-row items-center
         gap-20 my-20'>
            <div className='max-w-max mx-auto relative'>
                ...
                <div className='bg-white w-1/2 aspect-square absolute
                right-0 bottom-0 rounded-full translate-x-1/4 translate-y-1/3
                shadow-[0_4px_55px_rgba(149,0,162,0.15)] flex items-center
                justify-center'>
                    <img src={circular_text} alt="" className='w-full animate-spin_slow'/>
                    <img src={dev_icon} alt="" className='w-1/4 absolute top-1/2 
                    left-1/2 -translate-x-1/2 -translate-y-1/2'/>
                </div>
            </div>
            <div className='flex-1'>
                <p className='mb-10 max-w-2xl  font-Ovo'>
                    I'm a Java Full Stack Developer with 5 years of experience, proficient in both front-end and back-end development. I have strong expertise in HTML, CSS, JavaScript, React, and Spring frameworks. I’m passionate about creating efficient, scalable web applications and enjoy working on complex projects that challenge my skills. I'm always eager to learn and stay updated with the latest industry trends and technologies.
                </p>
                    ...
                    <li className='border-[0.5px] border-gray-400
                     ...
                     dark:hover:shadow-white dark:hover:bg-darkHover/50'>
                        ...
                        <p className='text-gray-600 text-sm dark:text-white/80'>
                            HTML, CSS, Javascript, React Js, Next Js, Java, Spring Framework
                        </p>
                    </li>
                    <li className='border-[0.5px] border-gray-400
                     rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1
                     ...
                     dark:hover:shadow-white dark:hover:bg-darkHover/50'>
                        ...
                        <p className='text-gray-600 text-sm dark:text-white/80'>
                            BE-IT (Thanlyin Technology University)
                        </p>
                    </li>
                    <li className='border-[0.5px] border-gray-400
                     rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1
